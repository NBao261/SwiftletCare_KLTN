...
import ActionsMenu, { type ActionsMenuItem } from '@/components/common/ActionsMenu'
import { getUserStatus } from '@/hooks/useUsers'
import { formatDate } from '@/utils/helpers'
import { STATUS_LABEL, STATUS_TONE, ROLE_LABEL } from './constants'
...
/**
 * Cấu hình cột bảng Người dùng — tách riêng khỏi UsersPage.tsx để trang chính
