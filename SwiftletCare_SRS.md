...
| GET    | `/devices/system-status` **[mới v1.19.0]** | Admin xem nhanh trạng thái mọi node toàn hệ thống — tóm tắt theo trạng thái + danh sách node kèm Farm/House/Zone (OPS-NFR-004) | JWT (ADMIN) |
