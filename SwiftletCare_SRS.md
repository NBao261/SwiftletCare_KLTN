...
| AUTH-FR-007                    | Ghi audit log mọi hành động đăng nhập, thay đổi cấu hình                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | Bắt buộc | ✅ Xong (`audit_logs` + `logAction()`: LOGIN/LOGIN_FAILED, khoá/mở khoá, xoá, tạo tài khoản, đổi ngưỡng, relay override, dời thiết bị, can thiệp ticket, duyệt Sales Staff) |
