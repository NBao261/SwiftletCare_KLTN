...
| AUTH-FR-005b | Farm Owner có thể mời Sales Staff vào Farm của mình (many-to-many); nếu Farm không có Sales Staff, Farm Owner tự động có toàn bộ quyền của Sales Staff trên Farm đó (permission-based, không ép buộc tạo tài khoản riêng) — xem Flow 16                                                                                                                                  | Bắt buộc | ✅ Xong (mời qua Invitation) |
| AUTH-FR-005c | Administrator có thể tạo tài khoản Technician và gán khu vực địa lý phụ trách (`assigned_regions`); Administrator cũng có thể tạo tài khoản Sales Staff và gán vào 1+ Farm cho trường hợp farm liên kết/hợp tác xã — xem Flow 16                                                                                                                                         | Bắt buộc | ⬜ Chưa cài (chưa có endpoint Admin tạo Technician/gán vùng) |
...
| AUTH-FR-010 **[mới v1.12.0]**  | Lời mời thành viên (Farm Owner mời Farm Owner khác — AUTH-FR-005, hoặc mời Sales Staff — AUTH-FR-005b) có TTL 7 ngày và trạng thái `PENDING → ACCEPTED / DECLINED / EXPIRED`; người được mời nhận thông báo (email/push) kèm link chấp nhận; nếu email chưa có tài khoản, chấp nhận lời mời dẫn thẳng vào luồng đăng ký (Flow 11) — xem Flow 12 | Bắt buộc | ✅ Xong |
...
| ENV-FR-007 | Giá trị khuyến nghị mặc định: Nhiệt độ 26–31°C, Độ ẩm 75–95%, Ánh sáng < 0.2 lux                                                                                                                                                                              | Bắt buộc | ⬜ N/A — chỉ là giá trị khuyến nghị, không phải logic code |
