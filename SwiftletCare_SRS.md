...
| FARM-FR-008                                   | **Technician** gỡ bỏ và thay thế thiết bị mà không mất lịch sử dữ liệu cũ (qua Web Console, không phải Farm Owner)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Bắt buộc | ✅ Xong (`POST /devices/{sensor|camera}-nodes/:id/decommission` gắn `decommissioned_at`, không xoá document nên telemetry theo `node_id` còn nguyên; `POST /devices/sensor-nodes/:id/replace` onboarding thiết bị mới cùng Zone + `replaced_by`) |
...
| TICKET-FR-013 | Hệ thống hỗ trợ bảo trì định kỳ: Administrator/Technician lên lịch bảo trì theo Farm, tự tạo ticket loại `MAINTENANCE` khi đến hạn                                                                                                                                                                                                              | Tùy chọn | ✅ Xong (`/maintenance-schedules` CRUD + job mỗi giờ tạo ticket MAINTENANCE qua Ticket Router, chống tạo trùng) |
